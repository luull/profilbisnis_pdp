...
<header>
    <nav id="my-nav1" class="navbar navbar-expand-lg navbar-light rounded-bar transparent-bar">
        ...
        <div class="logo small-screen">
            <a href="/{{ session('data')->username }}"><img src="{{ asset('images/company-logo/logo-default.png')}}" alt="Logo Img" class="logos-little"></a>
        </div>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent1">
                    <div class="collapse navbar-collapse">
                        <div class="col-3 col-md-2 col-lg-3 text-left p-0">
                            <div class="logo">
                                <a href="/{{ session('data')->username }}"><img src="{{ asset('images/company-logo/logo-default.png')}}" alt="Logo Img" class="logos"></a>
                            </div>
                        </div>
                        <div class="col-9 p-0">
        ...
        <div class="inner-wrapper">
            ...
            <nav class="side-nav w-100">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="#join">Daftar</a>
                    </li>
                    <li class="nav-item">
                        <a href="{{env('APP_URL')}}/kartunama/{{session('username')}}" rel="nofollow" target="_blank" class="btn btn-slider pink-btn rounded-pill">Kartu Nama</a>
                    </li>
