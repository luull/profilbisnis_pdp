...
<header id="header-content" class="fixed-top">
    <div class="container d-flex align-items-center justify-content-between">
        ...
        <h1 class="logo"><a href="/{{ $name }}"><img src="{{ asset('images/company-logo/logo-default.png')}}" alt="Logo Img" class="img-fluid"></a></h1>
        <nav id="navbar" class="navbar">
            <ul>
                ...
                <li><a class="nav-link getstarted" data-scroll-nav="0" href="{{env('APP_URL')}}/kartunama/{{ $name }}" rel="nofollow" target="_blank">Kartu Nama</a></li>
            </ul>
