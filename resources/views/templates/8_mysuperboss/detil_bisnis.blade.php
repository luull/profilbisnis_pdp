...
<section class="about-banner pb-0 padding-100">
    <div class="blog-detail-img parallaxie">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <h2 class="text-capitalize mb-15 text-center text-white">Detail Bisnis</h2>
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12">
                    @if($count_produk < 1) <br>
                        @else
                        <a href="{{ env('APP_URL') }}/{{$link}}/produk/{{ $bisnis->slug }}" class="btn btn-green btn-rounded mb-3" style="float:right;"><i class="fa fa-shopping-cart"></i> Daftar Produk</a>
                        @endif
                </div>
