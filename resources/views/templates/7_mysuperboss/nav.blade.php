        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="megaone">
                <div class="navbar-nav ml-auto">
                    ...
                    <a class="nav-link line scroll" href="#join">Daftar</a>
                    <a href="{{env('APP_URL')}}/kartunama/{{session('username')}}" rel="nofollow" target="_blank" class="btn btn-medium btn-rounded btn-primary ml-4">Kartu Nama</a>
                </div>
            </div>
        </div>
        ...
        <div class="inner-wrapper">
            ...
            <nav class="side-nav w-100">
                <ul class="navbar-nav side-navbar">
                    ...
                    <li class="nav-item">
                        <a href="{{env('APP_URL')}}/kartunama/{{session('username')}}" rel="nofollow" target="_blank" class="btn btn-medium btn-rounded btn-primary">Kartu Nama</a>
                    </li>
                </ul>
            </nav>
