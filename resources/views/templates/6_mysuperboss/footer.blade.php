    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-8 col-md-8 col-12 text-center">
                ...
                {{session('qrcode')}}
                <h4 class="fadeIn text-white mt-4"><strong>{{session('konfigurasi')->app_name}}</strong></h4>
    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-12 text-center">
                ...
                <!--Text-->
                <p class="company-about fadeIn text-white">&copy; {{session('konfigurasi')->copyright}}
                    Powered by <a href="{{session('konfigurasi')->app_url}}" class="text-light">{{session('konfigurasi')->poweredby}}</a></p>
