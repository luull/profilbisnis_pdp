...
<section class="breadcrumbs">
    <div class="container">
        <div class="d-flex justify-content-between align-items-center">
            <h2><a href="javascript:history.back(-1)"><i class="fa fa-angle-left"></i></a> Produk <span></span>
            </h2>
            <ol>
    ...
    <div class="container">
        ...
        <div class="row justify-content-center no-gutters" data-aos="fade-up">
            ...
            <div class="col-lg-4 col-md-6 content-item" data-aos="fade-up" data-aos-delay="100">
                ...
                <a href="https://wa.me/{{ $no_wa }}?text={{ $wa_template1 }} {{ $resulturl }}
                " target="_blank" class="btn btn-product mt-4 mb-3">Beli</a>
