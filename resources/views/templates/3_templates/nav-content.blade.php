            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item nav-btn">
                        <a class="btn button btn-rounded pink-btn btn-hvr-black" href="{{env('APP_URL')}}/kartunama/{{ $name }}" rel="nofollow" target="_blank">KARTU NAMA</a>
                    </li>
                </ul>
            </div>
        </div>
                ...
                <div class="row  side-menu-inner-content">
                    <div class="col-12 d-flex justify-content-center align-items-center text-center">
                        <a class="logo-image" href="#home">
                            <img src="{{ asset('images/company-logo/logo-asante-white.png')}}" alt="logo"></a>
                    </div>
