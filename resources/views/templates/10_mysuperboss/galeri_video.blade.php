...
<section class="bg-grey blog-content">
    <div class="container">
...
<script type="text/javascript">
    $(function() {
        $(".youtube").click(function() {
            ...
            var mbed = '<iframe id="videoPlayer" class="videoPlayer" style="width:auto ;height:auto;min-width:475px; min-height:315px;overflow:auto" src="https://www.youtube.com/embed/' + id + '?autoplay=1&rel=0&amp;showinfo=0" frameborder="0" allowfullscreen></iframe>';
            var ket = $("#ket-" + id).html();
