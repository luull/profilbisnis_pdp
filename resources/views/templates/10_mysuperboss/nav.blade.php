                ...
                <div class="col-8">
                    <div class="collapse navbar-collapse" id="megaone">
                        <div class="navbar-nav mx-auto">
                            ...
                            <a class="ml-4 mt-1 btn-card {{ Request::is('kontak') ? 'active' : '' }}" href="{{env('APP_URL')}}/kartunama/{{session('username')}}" rel="nofollow" target="_blank">Kartu Nama</a>
                        </div>
                    </div>
                </div>
                <!--Side Menu Button-->
    ...
    <div class="inner-wrapper">
        ...
        <nav class="side-nav w-100">
            <ul class="navbar-nav">
                ...
                <hr>
                <a href="{{env('APP_URL')}}/kartunama/{{session('username')}}" rel="nofollow" target="_blank" class="btn-card pb-0">Kartu Nama</a>
