...
<body>
    <div class="row justify-content-center pt-5 pl-2 pr-2">
        <div class="col-md-8 col-lg-4 ">
            ...
            <div class="card ml-2 mr-2">
               ...
               <div class="card-header ">
                    <h5 class="card-title text-center ">Login Cpanel</h5>
                </div>
                ...
                <div class="card-footer">
                    ...
                    <a href="/lupa_password" class="btn btn-warning float-right btn-rounded ">Lupa Password</a>
                </div>
            </form>
            </div>
        </div>
