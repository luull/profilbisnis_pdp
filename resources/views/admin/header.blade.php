      ...
      <nav class="navbar navbar-expand-lg main-navbar">
        ...
        <ul class="navbar-nav navbar-right">
          ...
          <li class="dropdown"><a href="#" data-toggle="dropdown"
              ...
              <img alt="image" src="{{ asset(session('admin_photo')) }}" class="user-img-radious-style"  alt="{{ session('admin_data')->nama }}">
              <span class="d-sm-none d-lg-inline-block"></span></a>
            <div class="dropdown-menu dropdown-menu-right">
              <div class="dropdown-title">Hallo {{ session('admin_data')->nama }}</div>
              <a href="/admin/profile" class="dropdown-item has-icon">
                <i class="far fa-user"></i> Profile
              </a>
              <a href="/admin/photo-profile" class="dropdown-item has-icon">
