    ...
    <form action="{{route('update_profile')}}" method="post">
        ...
        <div class="card-body">
            ...
            <div class="col-lg-6 col-md-6 text-center text-md-left">
                ...
                <div class="col-lg-8 col-md-8 text-left"><input type="text" class="form-control input-default @error('kelurahan')is-invalid @enderror" name="kelurahan" value="{{$admin_profil->kelurahan}}"> </div>
                </div>
                 <div class="row p-2" >
                ...
                <div class="col-lg-8 col-md-8 text-left">
                    <select name="propinsi" id="propinsi" class="form-control @error('propinsi')is-invalid @enderror" name="propinsi">
                        @foreach ($province as $prov)
                                @if ($prov->province_id==$admin_profil->propinsi)
                ...
                <div class="col-lg-8 col-md-8 text-left">
                    ...
                    @foreach ($city as $ct)
                                @if ($ct->city_id==$admin_profil->kota)
                ...
                <div class="col-lg-8 col-md-8 text-left">
                    ...
                    <select id="kecamatan" name="kecamatan" class="form-control input-default @error('kecamatan')is-invalid @enderror" >
                     @foreach ($subdistrict as $sd)
                                @if ($sd->subdistrict_id==$admin_profil->kecamatan)
            ...
            <div class="col-lg-6 col-md-6 text-center text-md-left">
                ...
                <div class="col-lg-8 col-md-8 text-left"><input type="text" class="form-control input-default @error('hp')is-invalid @enderror" name="hp" value="{{$admin_profil->hp}}"> </div>
                </div>
                <div class="row p-2" >
                <div class="col-lg-4 col-md-4 text-left">Whatsapp <span class="text-danger">*</span></div>
                <div class="col-lg-8 col-md-8 text-left"><input type="text" class="form-control input-default @error('wa')is-invalid @enderror" name="wa" value="{{$admin_profil->wa}}"> </div>
                </div>
                <div class="row p-2" >
                <div class="col-lg-4 col-md-4 text-left">Email</div>
                <div class="col-lg-8 col-md-8 text-left"><input type="text" class="form-control input-default @error('email')is-invalid @enderror" name="email" value="{{$admin_profil->email}}"> </div>
                </div>
                <div class="row p-2" >
                <div class="col-lg-4 col-md-4 text-left">Facebook </div>
                <div class="col-lg-8 col-md-8 text-left"><input type="text" class="form-control input-default @error('fb')is-invalid @enderror" name="fb" value="{{$admin_profil->fb}}"> </div>
                </div>
                <div class="row p-2" >
                <div class="col-lg-4 col-md-4 text-left">Twitter</div>
                <div class="col-lg-8 col-md-8 text-left"><input type="text" class="form-control input-default @error('twitter')is-invalid @enderror" name="twitter" value="{{$admin_profil->twitter}}"> </div>
                </div>
                <div class="row p-2" >
                <div class="col-lg-4 col-md-4 text-left">Instagram</div>
                <div class="col-lg-8 col-md-8 text-left"><input type="text" class="form-control input-default @error('ig')is-invalid @enderror" name="ig" value="{{$admin_profil->ig}}"> </div>
                </div>
                <div class="row p-2" >
                <div class="col-lg-4 col-md-4 text-left">Youtube Channel </div>
                <div class="col-lg-8 col-md-8 text-left"><input type="text" class="form-control input-default @error('tube')is-invalid @enderror" name="tube" value="{{$admin_profil->tube}}"> </div>
                </div>
                <div class="row p-2" >
