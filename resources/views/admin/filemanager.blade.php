...
<div class="row justify-content-center p-3">
    <a href="/admin/filemanager/images" class="btn btn-info">Images</a>
       &nbsp; <a href="/admin/filemanager/photos" class="btn btn-info">Photos</a>
       &nbsp;    <a href="/admin/filemanager/products" class="btn btn-info">Products</a>
       &nbsp;    <a href="/admin/filemanager/downloads" class="btn btn-info">Downloads</a>
