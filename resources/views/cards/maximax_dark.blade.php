...
<head>
    ...
    <!-- Main Stylesheet -->
    <link rel="stylesheet" href="{{asset('card/maximax_dark/css/main.css')}}">
    <!--Bootstrap-->
    <link rel="stylesheet" href="{{asset('card/maximax_dark/css/bootstrap.min.css') }}">

    <!-- Google Fonts -->
    <link rel="stylesheet" href="{{asset('card/maximax_dark/fonts/metropolis.css') }}">
    <link rel="stylesheet" href="{{asset('card/maximax_dark/font-awesome/font-awesome.min.css')}}">
...
<body>
    ...
    <!-- jQuery -->
    <script src="{{ asset('card/maximax_dark/js/html2canvas.js')}}"></script>
    <script src="{{ asset('card/maximax_dark/js/html2canvas.min.js')}}"></script>

    <!-- jQuery -->
    <script src="{{ asset('card/maximax_dark/js/jquery-3.6.0.min.js')}}"></script>
    <!-- Bootstrap -->
    <script src="{{ asset('card/maximax_dark/js/bootstrap.min.js')}}"></script>
    @yield('script')
</body>
@yield('modal')
