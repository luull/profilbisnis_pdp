...
<head>
    ...
    <!-- Main Stylesheet -->
    <link rel="stylesheet" href="{{asset('card/mysuperboss_1/css/main.css')}}">
    <!--Bootstrap-->
    <link rel="stylesheet" href="{{asset('card/mysuperboss_1/css/bootstrap.min.css') }}">
    <!-- Google Fonts -->
    <link rel="stylesheet" href="{{asset('card/mysuperboss_1/fonts/metropolis.css') }}">
    <link rel="stylesheet" href="{{asset('card/mysuperboss_1/font-awesome/font-awesome.min.css')}}">
...
<body>
    ...
    <!-- jQuery -->
    <script src="{{ asset('card/mysuperboss_1/js/html2canvas.js')}}"></script>
    <script src="{{ asset('card/mysuperboss_1/js/html2canvas.min.js')}}"></script>

    <!-- jQuery -->
    <script src="{{ asset('card/mysuperboss_1/js/jquery-3.6.0.min.js')}}"></script>
    <!-- Bootstrap -->
    <script src="{{ asset('card/mysuperboss_1/js/bootstrap.min.js')}}"></script>
    @yield('script')
</body>
@yield('modal')
