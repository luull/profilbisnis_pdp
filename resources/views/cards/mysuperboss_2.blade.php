...
<head>
    ...
    <!-- Main Stylesheet -->
    <link rel="stylesheet" href="{{asset('card/mysuperboss_2/css/main.css')}}">
    <!--Bootstrap-->
    <link rel="stylesheet" href="{{asset('card/mysuperboss_2/css/bootstrap.min.css') }}">
    <!-- Google Fonts -->
    <link rel="stylesheet" href="{{asset('card/mysuperboss_2/fonts/metropolis.css') }}">
    <link rel="stylesheet" href="{{asset('card/mysuperboss_2/font-awesome/font-awesome.min.css')}}">
...
<body>
    ...
    <!-- jQuery -->
    <script src="{{ asset('card/mysuperboss_2/js/html2canvas.js')}}"></script>
    <script src="{{ asset('card/mysuperboss_2/js/html2canvas.min.js')}}"></script>

    <!-- jQuery -->
    <script src="{{ asset('card/mysuperboss_2/js/jquery-3.6.0.min.js')}}"></script>
    <!-- Bootstrap -->
    <script src="{{ asset('card/mysuperboss_2/js/bootstrap.min.js')}}"></script>
    @yield('script')
</body>
@yield('modal')
