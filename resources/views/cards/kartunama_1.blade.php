...
<head>
    ...
    <!-- Main Stylesheet -->
    <link rel="stylesheet" href="{{asset('card/kartunama_1/css/main.css')}}">
    <!--Bootstrap-->
    <link rel="stylesheet" href="{{asset('card/kartunama_1/css/bootstrap.min.css') }}">
    <!-- Google Fonts -->
    <link rel="stylesheet" href="{{asset('card/kartunama_1/fonts/metropolis.css') }}">
    <link rel="stylesheet" href="{{asset('card/kartunama_1/font-awesome/font-awesome.min.css')}}">
...
<body>
                ...
                <div class="cardname" onclick="javascript:goToURL()" id="get" data-name="{{ session('data')->username }}">
                    <div class="row">
                        ...
                        <div class="col-lg-8 col-md-8 col-sm-8 col-8">
                            <div class="row mb-0">
                                <div class="col-md-12 top" onclick="javascript:goToURL()">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4 col-4 left">
                            <div class="row mb-0">
    ...
    <!-- jQuery -->
    <script src="{{ asset('card/kartunama_1/js/html2canvas.js')}}"></script>
    <script src="{{ asset('card/kartunama_1/js/html2canvas.min.js')}}"></script>

    <!-- jQuery -->
    <script src="{{ asset('card/kartunama_1/js/jquery-3.6.0.min.js')}}"></script>
    <!-- Bootstrap -->
    <script src="{{ asset('card/kartunama_1/js/bootstrap.min.js')}}"></script>
    @yield('script')
</body>
@yield('modal')
