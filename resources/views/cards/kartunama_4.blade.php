...
<head>
    ...
    <!-- Main Stylesheet -->
    <link rel="stylesheet" href="{{asset('card/kartunama_4/css/main.css')}}">
    <!--Bootstrap-->
    <link rel="stylesheet" href="{{asset('card/kartunama_4/css/bootstrap.min.css') }}">
    <!-- Google Fonts -->
    <link rel="stylesheet" href="{{asset('card/kartunama_4/fonts/metropolis.css') }}">
    <link rel="stylesheet" href="{{asset('card/kartunama_4/font-awesome/font-awesome.min.css')}}">
...
<body>
    ...
    <!-- jQuery -->
    <script src="{{ asset('card/kartunama_4/js/html2canvas.js')}}"></script>
    <script src="{{ asset('card/kartunama_4/js/html2canvas.min.js')}}"></script>

    <!-- jQuery -->
    <script src="{{ asset('card/kartunama_4/js/jquery-3.6.0.min.js')}}"></script>
    <!-- Bootstrap -->
    <script src="{{ asset('card/kartunama_4/js/bootstrap.min.js')}}"></script>
    @yield('script')
</body>
@yield('modal')
