...
<head>
    ...
    <!-- Main Stylesheet -->
    <link rel="stylesheet" href="{{asset('card/light_yellow/css/main.css')}}">
    <!--Bootstrap-->
    <link rel="stylesheet" href="{{asset('card/light_yellow/css/bootstrap.min.css') }}">

    <!-- Google Fonts -->
    <link href="https://fonts.googleapis.com/css?family=Open+Sans:300,300i,400,400i,600,600i,700,700i|Raleway:300,300i,400,400i,500,500i,600,600i,700,700i|Poppins:300,300i,400,400i,500,500i,600,600i,700,700i" rel="stylesheet">
    <link rel="stylesheet" href="{{asset('card/light_yellow/font-awesome/font-awesome.min.css')}}">
...
<body>
    ...
    <!-- jQuery -->
    <script src="{{ asset('card/light_yellow/js/html2canvas.js')}}"></script>
    <script src="{{ asset('card/light_yellow/js/html2canvas.min.js')}}"></script>

    <!-- jQuery -->
    <script src="{{ asset('card/light_yellow/js/jquery-3.6.0.min.js')}}"></script>
    <!-- Bootstrap -->
    <script src="{{ asset('card/light_yellow/js/bootstrap.min.js')}}"></script>
    @yield('script')
</body>
@yield('modal')
