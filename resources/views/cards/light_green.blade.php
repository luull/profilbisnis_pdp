...
<head>
    ...
    <!-- Main Stylesheet -->
    <link rel="stylesheet" href="{{asset('card/light_green/css/main.css')}}">
    <!--Bootstrap-->
    <link rel="stylesheet" href="{{asset('card/light_green/css/bootstrap.min.css') }}">

    <!-- Google Fonts -->
    <link href="https://fonts.googleapis.com/css?family=Open+Sans:300,300i,400,400i,600,600i,700,700i|Raleway:300,300i,400,400i,500,500i,600,600i,700,700i|Poppins:300,300i,400,400i,500,500i,600,600i,700,700i" rel="stylesheet">
    <link rel="stylesheet" href="{{asset('card/light_green/font-awesome/font-awesome.min.css')}}">
...
<body>
                                    ...
                                    <ul class="list-group">
                                        <div class="row row1">
                                            <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                                                ...
                                                @endif
                                                @if (!@empty($data->tube))
                                                <li class="list-group-item"><a href="https://youtuber/channel/{{$data->tube}}" target="_blank"><i class="fa fa-youtube"></i>{{$data->tube}}</a></li>
                                                @endif
                                                @if (!@empty($data->fb))
    ...
    <!-- jQuery -->
    <script src="{{ asset('card/light_green/js/html2canvas.js')}}"></script>
    <script src="{{ asset('card/light_green/js/html2canvas.min.js')}}"></script>

    <!-- jQuery -->
    <script src="{{ asset('card/light_green/js/jquery-3.6.0.min.js')}}"></script>
    <!-- Bootstrap -->
    <script src="{{ asset('card/light_green/js/bootstrap.min.js')}}"></script>
    @yield('script')
</body>
@yield('modal')
