...
<head>
    ...
    <!-- Main Stylesheet -->
    <link rel="stylesheet" href="{{asset('card/maximax_light/css/main.css')}}">
    <!--Bootstrap-->
    <link rel="stylesheet" href="{{asset('card/maximax_light/css/bootstrap.min.css') }}">

    <!-- Google Fonts -->
    <link rel="stylesheet" href="{{asset('card/maximax_light/fonts/metropolis.css') }}">
    <link rel="stylesheet" href="{{asset('card/maximax_light/font-awesome/font-awesome.min.css')}}">
...
<body>
            ...
            <div id="htmltoimage">
                <div class="cardname" onclick="javascript:goToURL()" id="get" data-name="{{ session('data')->username }}">
                    <div class="row">
                        ...
                        <div class="col-lg-7 col-md-7 col-sm-7 col-7 right">
                            <div class="row">
    ...
    <!-- jQuery -->
    <script src="{{ asset('card/maximax_light/js/html2canvas.js')}}"></script>
    <script src="{{ asset('card/maximax_light/js/html2canvas.min.js')}}"></script>

    <!-- jQuery -->
    <script src="{{ asset('card/maximax_light/js/jquery-3.6.0.min.js')}}"></script>
    <!-- Bootstrap -->
    <script src="{{ asset('card/maximax_light/js/bootstrap.min.js')}}"></script>
    @yield('script')
</body>
@yield('modal')
